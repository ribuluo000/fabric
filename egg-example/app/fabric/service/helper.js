...
async function getClientForOrg (userorg, username) {
  ...
  // return new hfc();
	...
	logger.info('getClientForOrg - ****** END %s %s \n\n', userorg, username)
...
var getRegisteredUser = async function(username, userOrg, isJson) {
	try {
		...
		logger.info('Successfully initialized the credential stores');
		...
		if (user && user.isEnrolled()) {
			...
			logger.info('Successfully enrolled username %s  and setUserContext on the client object', username);
		}
		if(user && user.isEnrolled) {
...
var getLogger = function(moduleName) {
  var logger = utils.getLogger(moduleName);
